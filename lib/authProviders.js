...
export const authProviders = {
  ...
  'vkontakte': {
    ...
    access_token_url: 'https://oauth.vk.com/authorize/access_token',
    api_url: 'https://api.vk.com/method',
    callback_url: _ => 'https://oauth.vk.com/blank.html',
    defaultParams: {
      response_type: 'token',
      v: '5.62',
      display: 'mobile',
      scope: 'friends,groups,market,offline,messages,wall'
    },
    validate: validate({
      client_id: [notEmpty],
      client_secret: [notEmpty]
